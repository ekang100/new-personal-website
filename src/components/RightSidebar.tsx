    ...
    >
      ...
      <div className="border-b border-white/10 px-3">
        <div className="flex items-center gap-2 py-2">
          <button className="rounded px-2 py-1 text-xs bg-white/10 text-white">Design</button>
...
/** Desktop-only fixed sidebar (unchanged behavior) */
export function RightSidebar() {
  return (
    <aside className="fixed top-10 bottom-0 right-0 z-30 w-80 pointer-events-none hidden md:block">
      <RightSidebarPanel />
    </aside>
  );
}
